...
<head>
  ...
  <script type="application/javascript">
    var smartInit = true;
    var versionResponsive = "version_responsive=" + window.deviceName;
    if (window.deviceSize === "M" && !false) {
      smartInit = false
    }
    if (smartInit) {
      let site_id = 244284;
      ...
      didomiNextConsent(45, (function () {
        ...
        sas.cmd.push((function () {
          ...
          if (document.cookie.split(" ") && document.cookie.split(" ").filter(elem => elem.split("=")[0] ==
              "firstid")[0] && document.cookie.split(" ").filter(elem => elem.split("=")[0] == "firstid")[0]
            .split("=")[1]) {
            firstid = document.cookie.split(" ").filter(elem => elem.split("=")[0] == "firstid")[0].split(
              "=")[1].replace(";", "")
          }
          if (!!firstid) {
            eids.push({
